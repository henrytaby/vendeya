            ...
            <div class="dropdown ">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    ...
                    <div class="row row-paddingless">
                        <!--begin:Item-->
                        <div class="col-6">
                            <a href="/sinpreh" class="d-block py-10 px-5 text-center bg-hover-light border-right border-bottom">
                                <span class=""><i class="flaticon2-start-up text-success icon-xl-2x"></i></span>
                                <span class="d-block text-dark-75 font-weight-bold font-size-h6 mt-2 mb-1">SINPREH</span>
