{literal}
<script>
    var snippet_form_{/literal}{$subcontrol}{literal}_actividad = function() {
        "use strict";
        ...
        var showResponse = function (res, statusText) {
            ...
            snippet_form_{/literal}{$subcontrol}{literal}.getActividad(res.id);
        };
        /**
    ...
    jQuery(document).ready(function() {
        snippet_form_{/literal}{$subcontrol}{literal}_actividad.init();
    });
