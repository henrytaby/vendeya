...
<script>
    ...
    var snippet_list = function() {
        ...
        var initTable = function() {
            ...
            table_list = table_list_var.DataTable({
                ...
                drawCallback: function( settings ) {
                    get_resumen_organismo_financiador();
                },
                keys: {
                    columns: noExport,
                    clipboard: false,
                ...
                columnDefs: [
...

                    {
                        ...
                        render: function(data,type,full,meta){
                            if (data == null){ data = "0";}
                            return '<div class="text-right" style="color: #4f8800;">' + new Intl.NumberFormat('en-US',{ minimumFractionDigits: 2 }).format(data) + ' Bs. </div>';
                        },
                    },
        ...
        var get_resumen_organismo_financiador = function(){
