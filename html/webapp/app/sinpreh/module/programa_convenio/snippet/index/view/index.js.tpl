    ...
    var snippet_list = function() {
        ...
        var initTable = function() {
            ...
            table_list = table_list_var.DataTable({
                ...
                pageLength: 10,
                //order: [[ 3, "asc" ]], // Por que campo ordenara al momento de desplegar
                InfoFiltered: false,
                searchDelay: 500,
                processing: true,
                serverSide: true,
...
*/
                ...
                columnDefs: [
...

                    {
                        ...
                        render: function(data, type, full, meta) {
                            var status = {
                                'Vigente': {'title': 'Vigente', 'class': ' label-light-primary'},
                                'No Vigente': {'title': 'No Vigente', 'class': ' label-light-info'},
                            };
...

                    {
                        ...
                        render: function(data,type,full,meta){
                            if (data == null){ data = "";}
                            return '<span class="text-primary font-size-sm">' + data+ '</span>';
                        },
                    },
