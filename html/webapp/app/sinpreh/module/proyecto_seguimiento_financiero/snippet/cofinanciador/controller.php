<?PHP
use App\Sinpreh\Module\ProyectoSeguimientoFinanciero\Snippet\Cofinanciador\Index;
use App\Sinpreh\Module\ProyectoSeguimientoFinanciero\Snippet\Cofinanciador\Catalog;
use Core\Core;
...
switch($action){
    ...
    case 'list':
        ...
        $res = $objItem->getItemDatatableRows($item_id,$numTable,$filter);
        Core::printJson($res);
        break;
    case 'get.form':
    ...
    case 'get.resumenorgfinanciador':
        $total = $objItem->getTotal($item_id,$entidad);
