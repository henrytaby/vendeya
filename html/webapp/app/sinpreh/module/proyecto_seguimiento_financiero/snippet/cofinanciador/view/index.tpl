<div class="card card-custom">
    ...
    <div class="card-body pt-0 pb-0 pl-5 pr-5 mb-10 ">
        {include file="index.search.tpl"}
    </div>


    <div id="principal_seguimiento" class="card card-custom p-0 m-0 d-none">

    <div class="card-body pb-0 pt-1" id="resumen_organismo_financiador"></div>
    <!--begin:Titulo-->
    ...
    <!--end: Lista de Datos-->
    {include file="nofinanciera/index.tpl"}
    {*
        {include file="ejecucion/index.tpl"}
    *}
