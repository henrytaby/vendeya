{include file="nofinanciera/form/form.css.tpl"}
<form method="POST"
    ...
    {if $item.id != "" or $type == 'new'}
        <div class="modal-body">
            ...
            <div class="form-group row mb-0">
                ...
                <div class="col-lg-12">
                    <label>{#field_proyecto_financiador_id#} :</label>
                    <div class="input-group">
                        <input type="text" class="form-control  pr-5 "
                               name="entidad_form" id="entidad_form" value="" disabled
                               data-fv-not-empty___message="{#glFieldRequired#}"
                        >
                        <input type="hidden" name="item[proyecto_financiador_id]" id="proyecto_financiador_id" value="{$item.proyecto_financiador_id}">
                    </div>
                </div>
...
{include file="nofinanciera/form/form.js.tpl"}
