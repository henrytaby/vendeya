<?PHP
use App\Sinpreh\Module\ProyectoSeguimientoFinanciero\Snippet\Index\Index;
use App\Sinpreh\Module\ProyectoSeguimientoFinanciero\Snippet\Index\Catalog;
use Core\Core;
...
switch($action) {
    ...
    case 'itemUpdate':
        ...
        $smarty->assign("menu_tab_active", "transferencia");
        /**
         * GetItem
         */
        if ($type == "update") {
