...
$grid_table[] = array(
    "table" => $appVars["table"] ["proyecto_transferencia"] // Nombre de la tabla con la que hara la relación
,    "alias"=> "pt" //Alias de la tabla para el join
,   "field_id"=>"id" //Id de la tabla que hara la relación
,   "relationship_id"=>"proyecto_transferencia_id" //Campo de relación en la tabla principal
);
...
$grid_table[] = array(
    "table" => $appVars["table"] ["proyecto_programa_convenio"] // Nombre de la tabla con la que hara la relación
,    "alias"=> "ppc" //Alias de la tabla para el join
,   "field_id"=>"id" //Id de la tabla que hara la relación
,   "relationship_id"=>"proyecto_programa_convenio_id" //Campo de relación en la tabla principal
);
...
,   "field_id"=>"id" //Id de la tabla que hara la relación
,   "relationship_id"=>"ppc.programa_convenio_id" //Campo de relación en la tabla principal
);
...
$grid_item[]=array( "field" => "detalle", "label"=> $smarty->config_vars["table_proyecto_transferencia_id"]
, "table_as"=> "pt", "as" => "proyecto_transferencia_id");
...
$grid_item[]=array( "field" => "nombre", "label"=> $smarty->config_vars["table_proyecto_programa_convenio_id"]
, "table_as"=> "pc", "as" => "financiamiento_nombre");


$grid_item[]=array( "field" => "codigo", "label"=> $smarty->config_vars["table_proyecto_programa_convenio_id"]
, "table_as"=> "pc", "as" => "financiamiento_codigo");
...
,    "alias"=> "pf" //Alias de la tabla para el join
,   "field_id"=>"id" //Id de la tabla que hara la relación
,   "relationship_id"=>"proyecto_financiador_entidad_id" //Campo de relación en la tabla principal
);
