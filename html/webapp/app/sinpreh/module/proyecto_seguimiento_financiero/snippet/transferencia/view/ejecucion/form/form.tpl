{include file="ejecucion/form/form.css.tpl"}
<form method="POST"
        ...
        <div class="modal-body">
            ...
            <div class="form-group row mb-0">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="input-group">
                        <select class="form-control m-select2 select2_general"
                                name="item[proyecto_financiador_entidad_id]" id="proyecto_financiador_entidad_id"
                                data-placeholder="{#field_holder_proyecto_financiador_id#}" {$privFace.input}
                                required
                                data-fv-not-empty___message="{#glFieldRequired#}"
                        >
                            <option></option>
                            {html_options options=$cataobj.financiador selected=$item.proyecto_financiador_entidad_id}
                        </select>
                    </div>
...
{include file="ejecucion/form/form.js.tpl"}
