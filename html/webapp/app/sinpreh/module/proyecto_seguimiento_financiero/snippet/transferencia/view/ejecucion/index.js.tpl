...
<script>
    ...
    var snippet_list_02 = function() {
        ...
        var initTable = function() {
            ...
            let table_list_var = $('#tabla_02_{/literal}{$subcontrol}{literal}');
            let export_title = "{/literal}{#dataTableExportTitle_02#}{literal}";
            let noExport = tableSetting.noExport;
            table_list_02 = table_list_var.DataTable({
                ...
                pageLength: 25,
                order: [[ 1, "asc" ],[ 0, "asc" ]], // Por que campo ordenara al momento de desplegar
                InfoFiltered: false,
                searchDelay: 500,
                processing: true,
                serverSide: true,
                ...
                columns: [
                    {/literal}{foreach from=$gridItem_02 item=row key=idx}
                ...
                columnDefs: [
                    {
                        ...
                        render: function(data, type, full, meta) {
                            ...
                            boton += '<a href="javascript:snippet_list_02.update(\''+data+'\');" class="btn btn-success btn-sm" title="'+lbEdit+'">'+lbEdit+'</a>';
                            {/literal}{if $privFace.edit ==1 and $privFace.delete == 1}{literal}
                            boton += '<a href="javascript:snippet_list_02.delete(\''+data+'\');" class="btn btn-icon btn-light-danger btn-sm" title="'+lngUyuni.btnDelete+'"><i class="flaticon-delete-1"></i></a>';
                            {/literal}{/if}{literal}
                            boton += '<div>';
                            return boton;
                        },
...

                    {
                        ...
                        render: function(data,type,full,meta){
                            var download = "";
                            if(data) {
                                download = ' <a href="javascript:snippet_list_02.download(\''+full.actions+'\');"  ' +
         ...
         * New and Update
         */
        var btn_update = $('#btn_form_02_{/literal}{$subcontrol}{literal}');
        ...
        var  item_delete = function(id){
            ...
            coreUyuni.itemDelete(id,url,table_list_02);
        };
