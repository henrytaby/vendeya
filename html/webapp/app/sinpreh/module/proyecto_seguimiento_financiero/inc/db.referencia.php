...
$db_table[] = Core::getTableConfig("proyecto_transferencia_seguimiento");
$db_table[] = Core::getTableConfig("proyecto_transferencia_devolucion");
$db_table[] = Core::getTableConfig("proyecto_transferencia_ejecucion");
$db_table[] = Core::getTableConfig("proyecto_cofinanciador_ejecucion");
