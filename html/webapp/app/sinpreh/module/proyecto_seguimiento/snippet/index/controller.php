<?PHP
use App\Sinpreh\Module\ProyectoSeguimiento\Snippet\Index\Index;
use App\Sinpreh\Module\ProyectoSeguimiento\Snippet\Index\Catalog;
use Core\Core;
...
switch($action) {
    ...
    case 'itemUpdate':
        ...
        $smarty->assign("menu_tab_active", "fisico");
        /**
         * GetItem
         */
        if ($type == "update") {
