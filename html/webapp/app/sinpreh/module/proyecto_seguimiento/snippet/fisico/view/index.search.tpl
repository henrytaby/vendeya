<div class="row alert alert-custom alert-light-primary fade show m-0 pr-0 pl-0 pt-0 pb-5 " role="alert" >
    <div class="col-lg-12 alert-text">
        ...
        <select class="form-control select2_general fitrodato" id="meta" data-col-index="0" >
            <option value="0">{#filter_meta_opt#}</option>
            {html_options options=$cataobj.proyecto_actividad}
        </select>
    </div>
