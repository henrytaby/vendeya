...
*}
    <div class="card-body " id="avance_fisico_total"></div>
    <div class="card-body pt-0 pb-0 pl-5 pr-5 mb-10 ">
        {include file="index.search.tpl"}
    </div>

    <div class="card-header py-3 d-none" id="botones_seguimiento">
    ...
    <div class="card-body" id="avance_fisico_meta"></div>

    <!--begin: Lista de Datos-->
    <div class="card-body pt-0 pb-0 pl-5 pr-5 mb-10 ">

        <!--begin: Datatable-->
        <div id="listametas" class="d-none">
