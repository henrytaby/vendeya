...
<div class="d-flex align-items-center flex-wrap">
    ...
    {foreach from=$res.tipo item=row key=idx}
        ...
        <div class="d-flex align-items-center flex-lg-fill mr-5 my-1">
            ...
            <div class="d-flex flex-column text-dark-75">
                ...
                <span class="font-weight-bolder font-size-h5 text-info" >{$row.total|number_format:2:',':'.'} <span class="text-dark-50 font-weight-bold">Km<sup>2</sup></span> </span>
            </div>
        </div>
        <!--end: Item-->
    {/foreach}
    ...
    <div class="d-flex align-items-center flex-lg-fill mr-5 my-1">
        ...
        <div class="d-flex flex-column text-dark-75">
            ...
            <span class="font-weight-bolder font-size-h5 text-success" >{$res.total|number_format:2:',':'.'} <span class="text-dark-50 font-weight-bold">Km<sup>2</sup></span> </span>
        </div>
    </div>
    <!--end: Item-->
</div>
