...
<div class="m-widget1__item">
    <div class="row m-row--no-padding">
        <div class="col-md-6 col-lg-12 text-left" >
            <h4 class="titulo_esta">Departamento - Aporte total</h4>
...
<table class="table {*table-separate table-striped*}  table-bordered table-hover table-head-custom table-checkable  table-sm  "
    ...
    {foreach from=$res.resultado item=row key=idx}
        <tr>
            <td>{$row.tipo}</td>
            <td>{$row.estado}</td>
            <td style="text-align: right;color:#066d12;">{$row.total|number_format:2:',':'.'} <span class="text-dark-50 font-weight-bold">bs.</span></td>
        </tr>
    {/foreach}
    </tbody>
    <tfoot></tfoot>
...
<div class="m-widget1__item">
    <div class="row m-row--no-padding">
        <div class="col-md-6 col-lg-12 text-left" >
            <h4 class="titulo_esta">Aporte total por tipo</h4>
    ...
    <div class="m-widget1__item">
        <div class="row m-row--no-padding">
            <div class="col-md-6 col-lg-12 text-left" >
                <h4 class="titulo_esta">Por Tipo de Proyecto - Años (<span class="text-dark-50 font-weight-bold">bs.</span>) </h4>
