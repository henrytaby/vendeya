<?PHP
namespace App\Sinpreh\Module\ProyectoConvenio\Snippet\Index;
...
class Index extends CoreResources {
    ...
    public function getItemDatatableRows(){
        ...
        foreach ($result['data'] as $itemId => $valor) {
            ...
            if(isset($result['data'][$itemId]['fecha_firma']))
                $result['data'][$itemId]['fecha_firma'] = $this->changeDataFormat($result['data'][$itemId]['fecha_firma'],"d/m/Y");
            ...
            if(isset($result['data'][$itemId]['fecha_conclusion']))
                $result['data'][$itemId]['fecha_conclusion'] = $this->changeDataFormat($result['data'][$itemId]['fecha_conclusion'],"d/m/Y");

            if(isset($result['data'][$itemId]['convenio_vigencia_fecha']))
                $result['data'][$itemId]['convenio_vigencia_fecha'] = $this->changeDataFormat($result['data'][$itemId]['convenio_vigencia_fecha'],"d/m/Y");
