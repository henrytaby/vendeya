...
$db_table[] = Core::getTableConfig("convenio_enmienda");
$db_table[] = Core::getTableConfig("convenio_archivo");
...
$db_table[] = Core::getTableConfig("componente");


$db_table[] = Core::getTableConfig("convenio_vigencia_tipo");
