 ...
 */
/*
$CFGm->folderParent = "core";
$CFGm->directory = $CFG->data.$CFGm->folderParent."/";
$core->createDirectory($CFGm->directory);
*/
/**
 * Verificamos y/o Creamos la carpeta del módulo
 */
/*
$CFGm->folderModule = "ingreso";
$CFGm->directory = $CFGm->directory.$CFGm->folderModule."/";
$core->createDirectory($CFGm->directory);
*/
